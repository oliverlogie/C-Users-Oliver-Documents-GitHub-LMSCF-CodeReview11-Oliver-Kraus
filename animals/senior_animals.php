...
ob_start();
// session_start();
require_once '../process/process_senior.php';
...
$sql = "SELECT * FROM senior_animals";
$result = mysqli_query($connect, $sql);
?>
<div class="container">
  <div class="row justify-content-center border border-white mt-5 mb-5">
  <h1 class="display-3">Senior animals tabel</h1>
  ...
  <tr class="text-white">
    ...
    <td>
    <a href="senior_animals.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary" >Edit</a>
      <a href="senior_animals.php?delete=<?php echo $row['id']; ?>" class="btn btn-info" >Delete</a>
    </td>
  </tr>
  <?php endwhile; ?>
    </table>
...
<form action="../process/process_senior.php" method ="post" class="border text-center ml-5 mr-5">
    <h1 class="display-4">Edit senior animals tabel</h1>
